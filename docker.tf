...
resource "aws_security_group" "ec2_security_group" {
  ...
  ingress {
    description      = "http py-nginx access1"
    from_port        = 9091
    to_port          = 9091
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "http py-nginx access2"
    from_port        = 9092
    to_port          = 9092
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "http py-nginx access3"
    from_port        = 9093
    to_port          = 9093
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "http py-nginx access4"
    from_port        = 9094
    to_port          = 9094
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "http py-nginx access"
    from_port        = 9095
    to_port          = 9095
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
